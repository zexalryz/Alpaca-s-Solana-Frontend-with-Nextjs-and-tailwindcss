        ...
        <div className=" bg-[#90329a] px-2 py-32 md:px-20 sm:px-14" id="about">
            ...
            <div className="sm:flex bg-[#b13bbe] container items-center max-w-6xl px-8 mx-auto xl:px-5">
                <div className="w-full pt-6 md:px-10 pt-6 w-full sm:w-full px-5 pt-6">
                    ...
                    <img className="w-full h-auto overflow-hidden shadow-xl rounded-xl" src={gif.src} alt="Alpaca's" />
                    ...
                    <p className="text-[#fff] text-xl mb-2 md:mb-6">The Alpaca Project is made up of 999 Alpaca's. The vision of the project is to create a tight knit community where you can safely discuss all things Crypto/NFT with the goal of providing ongoing value to every holder and the community in general.</p>
