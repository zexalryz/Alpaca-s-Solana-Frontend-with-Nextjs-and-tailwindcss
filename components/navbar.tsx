...
function ButtonLink({to, children}) {
    return <button href={to} className={`mx-4 bg-transparent hover:bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-white font-bold py-2 px-4 border border-indigo-500 border-t-purple-500 border-r-indigo-500 border-b-purple-500 rounded-full`}>
        {children}
    </button>
}
            ...
            <div className="w-9/12 flex justify-end items-center">
                ...
                <div className="hidden md:flex ">
                    ...
                    <NavLink to="https://twitter.com/alpaca_friends">
                        <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 ml-1 c bg-transparent" width={25} height={25} viewBox="0 0 26 22">
